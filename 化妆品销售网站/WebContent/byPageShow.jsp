...
<%    
 ...
 <p font-size=13px>每页最多显示<jsp:getProperty name="dataBean" property="pageSize"/>条信息
 ...
 <table> 
	<tr><td><FORM action="" method=post>
          ...
          <Input id="bt" type=submit name="g" value="上一页"></FORM></td>
    <td><FORM action="" method=post>
          <Input type=hidden name="currentPage"
           value="<%=dataBean.getCurrentPage()+1 %>">
          <Input id="bt" type=submit name="g" value="下一页"></FORM></td></tr>
	<tr><td><FORM action="" method=post>
                    每页显示<Input type=text name="pageSize" value =1 size=3>
                    条记录<Input id="bt" type=submit name="g" value="确定"></FORM></td>
	<td><FORM action="" method=post>
                    输入页码：<Input type=text name="currentPage" size=2 >
      	  <Input id="bt" type=submit name="g" value="提交"></FORM></td></tr></table> 
</center>
</BODY></HTML>